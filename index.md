...
<div class="hero-block">
  ...
  <div class="hero-bg" style="background-image:url('{{ "/images/experiment_theory.jpg" | relative_url }}');"></div>

  <!-- mobile image (shown only on small screens by CSS below) -->
  <img class="hero-mobile" src="{{ "/images/experiment_theory.jpg" | relative_url }}" alt="Experiment & theory hero">
...
---
### Recent Highlights?
<!-- Hero: Recent Highlights -->
<div style="position:relative;min-height:280px;border-radius:12px;overflow:hidden;margin-bottom:1.5rem;">
  <div style="position:absolute;inset:0;
       background:url('{{ "/images/Highlights.jpg" | relative_url }}') center/cover no-repeat;
       filter:brightness(0.85);"></div>
  <div style="position:relative;z-index:1;display:flex;min-height:280px;align-items:center;justify-content:center;">
    <h1 style="color:white;text-shadow:0 2px 12px rgba(0,0,0,.35);font-size:clamp(24px,4vw,40px);margin:0;padding:0 1rem;text-align:center;"></h1>
  </div>
  <!-- Fallback to ensure the asset is pulled even if CSS bg is cached weirdly -->
  <img src="{{ "/images/highlights.png" | relative_url }}" alt="" style="width:0;height:0;opacity:0;">
</div>
---
